...
Usamos los datos [data_rossi.csv](/diapositivas/data_rossi.csv) de un estudio sobre reicidencia delictiva
...
```{r, echo=T, eval=F, message=F, fig.height=6}
...
```{r, echo=F, include=T, message=F, fig.height=7}
...
.pull-left[
```{r, echo=T, eval=F, message=F, fig.height=7}
...
```{r, echo=F, include=T, message=F, fig.height=3}
...
```{r, echo=T, eval=T, message=F, fig.height=6}
